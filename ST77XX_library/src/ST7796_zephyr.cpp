...
ST7796_zephyr::ST7796_zephyr(struct spi_dt_spec * pspi, const struct gpio_dt_spec *CS, const struct gpio_dt_spec *DC, const struct gpio_dt_spec *RST) :
...
void  ST7796_zephyr::begin(uint16_t width, uint16_t height, uint32_t spi_clock)
{
